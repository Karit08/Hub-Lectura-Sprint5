VERSION 5.00
Begin VB.Form DetalleGeneroFavorito 
   ...
   Begin VB.CommandButton eliminar 
      BackColor       =   &H00C0C0FF&
      Caption         =   "Quitar género de favoritos"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "DetalleGeneroFavorito"
...
Private Sub Atras_Click()
    Dim frm As New GeneroFavoritoLista
    Unload Me
    frm.idRecibido = idRecibido
    frm.nombre = nombre
    frm.id_genero = nombre_genero
    frm.Show
End Sub
...
Private Sub favorito_Click()
    ...
    ' Condición para insertar registro de libro favorito en su tabla
    If contador = 0 Then
        ...
        ' Condición para insertar registro de libro favorito en su tabla, si no hay registros similares en eliminados
        If eliminado = 0 Then
...
Private Sub eliminar_Click(Index As Integer)
    ...
    respuesta = MsgBox("Al seleccionar esta opción, se eliminará toda la categoría de la sección de géneros favoritos. ¿Desea continuar?", vbYesNo + vbQuestion, "Confirmación")

    If respuesta = vbYes Then
    
        deleteQuery = "DELETE FROM genero_favorito WHERE id_usuario = " & idRecibido & " AND id_genero = " & id_genero
        Con.Execute deleteQuery
        
        ' Mostrar mensaje de confirmación
        MsgBox "Toda la categoria ha sido eliminada de tu lista de géneros favoritos"
    ...
    Else
        MsgBox "Se mantuvo tu categoria en la lista de generos favoritos"
    End If
