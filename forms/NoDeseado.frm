...
Begin VB.Form NoDeseado 
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   "Bienvenido a su sección de Libros no deseados. Seleccione el libro de su preferencia para restaurar su información."
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
...
Private Sub Command2_Click()
    ...
    Else
        Dim frm As New DetalleNoDeseado
        frm.idRecibido = idRecibido
        frm.nombre = nombre
