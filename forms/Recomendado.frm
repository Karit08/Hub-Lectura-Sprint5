...
Begin VB.Form Recomendado 
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   "Bienvenido a su sección de Libros recomendados. Seleccione el libro de su preferencia para acceder a su información."
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
...
Private Sub Command2_Click()
    ...
    Else
        ...
        Dim frm As New DetalleRecomendado
        frm.idRecibido = idRecibido
        frm.nombre = nombre
...
Private Sub Form_Load()
    Presentacion.Caption = "Bienvenido " + nombre
     ...
     ' Inicializa los objetos de conexión y recordset
