VERSION 5.00
Begin VB.Form DetalleNoDeseado 
   ...
   Begin VB.CommandButton eliminar 
      BackColor       =   &H00C0C0FF&
      Caption         =   "Eliminar de libros No deseados"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "DetalleNoDeseado"
...
Private Sub eliminar_Click(Index As Integer)
    ...
    deleteQuery = "DELETE FROM contenido_eliminado WHERE id_usuario = " & idRecibido & " AND id_libro = " & id
    Con.Execute deleteQuery

    ' Mostrar mensaje de confirmación
    MsgBox "Este contenido ha sido restaurado a toda la lista de contenidos"
