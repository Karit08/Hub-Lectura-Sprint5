...
Begin VB.Form DetalleLeido 
   ...
   End
End
Attribute VB_Name = "DetalleLeido"
...
Private Sub eliminar_Click(Index As Integer)
    ...
    deleteQuery = "DELETE FROM contenido_leido WHERE id_usuario = " & idRecibido & " AND id_libro = " & id
    Con.Execute deleteQuery

    ' Mostrar mensaje de confirmación
    MsgBox "Este contenido ha sido eliminado de tu lista de leídos"
