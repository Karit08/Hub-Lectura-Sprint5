...
Begin VB.Form LeerMasTarde 
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   "Bienvenido a su sección de Libros para leer más tarde. Seleccione el libro de su preferencia para acceder a su información."
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "LeerMasTarde"
...
Private Sub Command2_Click()
    ...
    Else
        ...
        Dim frm As New DetalleLeerMasTarde
        frm.idRecibido = idRecibido
        frm.nombre = nombre
...
Private Sub Form_Load()
    ...
    sqlQuery = "SELECT * FROM Catalogo " & _
                "WHERE id IN ( " & _
                "    SELECT id_libro " & _
                "    FROM contenido_leer_mas_tarde " & _
                "    WHERE id_usuario = " & idRecibido & _
                ") AND id NOT IN ( " & _
                "    SELECT id_libro " & _
                "    FROM contenido_eliminado " & _
                "    WHERE id_usuario = " & idRecibido & _
                ");"
    ...
    If Not Rec.EOF Then
        ...
        Loop
    Else
        MsgBox "No tienes libros en tu lista de leer mas tarde"
