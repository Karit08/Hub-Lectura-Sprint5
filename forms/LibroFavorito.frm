...
Begin VB.Form LibroFavorito 
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   "Bienvenido a su sección de Libros favoritos. Seleccione el libro de su preferencia para acceder a su información."
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "LibroFavorito"
...
Private Sub Command2_Click()
    ...
    Else
        Dim frm As New DetalleLibroFavorito
        frm.idRecibido = idRecibido
        frm.nombre = nombre
...
Private Sub Form_Load()
    ...
    If Not Rec.EOF Then
        ...
        Loop
    Else
        MsgBox "No tienes libros en tu lista de libros favoritos"
